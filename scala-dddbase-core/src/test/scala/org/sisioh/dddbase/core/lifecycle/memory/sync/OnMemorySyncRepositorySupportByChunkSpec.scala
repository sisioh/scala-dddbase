...
class OnMemorySyncRepositorySupportByChunkSpec extends Specification with Mockito {
  ...
  class EntityImpl(val identity: Identity[Int])
    ...
    def compare(that: OnMemorySyncRepositorySupportByChunkSpec.this.type#EntityImpl): Int = {
  ...
  class TestSyncRepository
    ...
    with OnMemorySyncRepositorySupportByChunk[TestSyncRepository, Identity[Int], EntityImpl]
